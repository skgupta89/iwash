    ...
    <div className="w-full   px-5 py-10  text-gray-800">
        <div className="w-full max-w-6xl mx-auto">
            <div className="text-center max-w-xl mx-auto">
                <h1 className="text-2xl md:text-4xl font-bold mb-5 text-[#e81c2e]">What our customer say about us</h1>
                <h3 className="text-xl mb-5 font-light">Lorem ipsum dolor sit amet consectetur adipisicing elit.</h3>
                <div className="text-center mb-10">
                    <span className="inline-block w-1 h-1 rounded-full bg-[#e81c2e] ml-1"></span>
                    <span className="inline-block w-3 h-1 rounded-full bg-[#e81c2e] ml-1"></span>
                    <span className="inline-block w-40 h-1 rounded-full bg-[#e81c2e]"></span>
                    <span className="inline-block w-3 h-1 rounded-full bg-[#e81c2e] ml-1"></span>
                    <span className="inline-block w-1 h-1 rounded-full bg-[#e81c2e] ml-1"></span>
                </div>
            </div>
            <div className="-mx-3 md:flex items-start ">
                <div className="px-3 md:w-1/3">
                    <div className="w-full mx-auto rounded-lg border border-gray-600 p-5 text-gray-800 font-light mb-6">
